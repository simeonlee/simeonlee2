        ...
        <nav className="wrap navbar navbar-default" role="navigation">
          <div className="container-fluid">
            ...
            <div className="navbar-collapse collapse" id="navigation">
              <IndexLink className="navbar-brand" to="/"><span className="logo">Simeon Lee</span></IndexLink>
              <ul className="nav navbar-nav navbar-left">
                <li><Link className="nav-link" activeClassName="nav-active" to="/">Home</Link></li>
              </ul>
            </div>
          </div>
        </nav>
